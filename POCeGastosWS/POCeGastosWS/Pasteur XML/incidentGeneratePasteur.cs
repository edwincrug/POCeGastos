...
namespace eGastosWS.Pasteur_XML
{
    public class incidentGeneratePasteur
    {
        //private int incidentGeneratePasteur_old(Entity.MasterEntity me, Entity.FilterData fd, out string msgError, out int nIncident, bool isApprove)
        //{
        ...
        //                LarXML.Append("          <debitCard xmlns='http://processSchema.eGastos/'>false</debitCard> ");
